...
import {Truck, Lock, RotateCcw, Clock, icons} from 'lucide-react'

const features=[
    {icon:Truck, text:'Free Shippping', subtext:'On orders over $100'},
    {icon:Lock, text:'Secure Payment', subtext:'100% protected payments'},
    {icon:Truck, text:'Easy Returns', subtext:'30-days return policy'},
    {icon:Truck, text:'24/7 Support', subtext:'Dedicated customer service'},
  ...
  return (
    <div className='bg-gray-100 py-8 px-4 lg:px-8'>
        <div className='max-w-7xl mx-auto'>
            <div className='grid grid-cols-1 gap-y-8 sm:grid-cols-3 lg:grid-cols-4 lg:gap-x-8'>{
