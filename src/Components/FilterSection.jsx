...
const FilterSection = ({search, setSearch, brand, setBrand, priceRange, setPriceRange, catergory, setCategory, handleBrandChange,handleCategoryChange }) => {
  ...
  return (
    <div className='bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block'>
      ...
      <button className='bg-red-500 text-white rounded-md py-1 px-3 mt-5 cursor-pointer'
      onClick={()=>{setSearch('');
        setCategory('All');
        setBrand('All')
